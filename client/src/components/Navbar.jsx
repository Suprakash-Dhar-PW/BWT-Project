...
import { LayoutGrid, Vote, BarChart3, Shield, LogOut, Menu, X } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="md:hidden">
            <Button variant="secondary" size="sm" onClick={() => setIsOpen(!isOpen)} icon={isOpen ? X : Menu} />
          </div>
        </div>
      </div>
              ...
              {navigation.map((item) => (
                <Link
                  ...
                  className={cn(
                    ...
                    location.pathname === item.href ? "bg-slate-900 text-white" : "text-slate-500 bg-slate-50"
                  )}
                >
